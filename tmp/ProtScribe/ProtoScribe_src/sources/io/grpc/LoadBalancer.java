...
public abstract class LoadBalancer {
    ...
    public static abstract class PickSubchannelArgs {
        ...
        public PickDetailsConsumer getPickDetailsConsumer() {
            return new PickDetailsConsumer() { // from class: io.grpc.LoadBalancer.PickSubchannelArgs.1
            };
        }
    }
    ...
    public static abstract class Helper {
        ...
        public MetricRecorder getMetricRecorder() {
            return new MetricRecorder() { // from class: io.grpc.LoadBalancer.Helper.1
            };
        }
    }
    ...
    public static final class FixedResultPicker extends SubchannelPicker {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof FixedResultPicker) {
                return this.result.equals(((FixedResultPicker) obj).result);
            }
            return false;
        }
    }
