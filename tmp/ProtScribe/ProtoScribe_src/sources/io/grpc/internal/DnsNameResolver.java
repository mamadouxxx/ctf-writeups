...
public class DnsNameResolver extends NameResolver {
    ...
    final class Resolve implements Runnable {
        ...
        */
        ...
        /* JADX INFO: renamed from: lambda$run$0$io-grpc-internal-DnsNameResolver$Resolve, reason: not valid java name */
        /* synthetic */ void m204lambda$run$0$iogrpcinternalDnsNameResolver$Resolve(NameResolver.ResolutionResult.Builder builder) {
            this.savedListener.onResult2(builder.build());
        }
    }
