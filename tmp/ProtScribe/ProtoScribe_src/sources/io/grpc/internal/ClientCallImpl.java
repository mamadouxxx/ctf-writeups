...
final class ClientCallImpl<ReqT, RespT> extends ClientCall<ReqT, RespT> {
    ...
    private void startInternal(final ClientCall.Listener<RespT> listener, Metadata metadata) {
        ...
        boolean z = deadlineEffectiveDeadline != null && deadlineEffectiveDeadline.equals(this.context.getDeadline());
        ClientCallImpl<ReqT, RespT>.CancellationHandler cancellationHandler = new CancellationHandler(deadlineEffectiveDeadline, z);
        this.cancellationHandler = cancellationHandler;
        if (deadlineEffectiveDeadline == null || ((CancellationHandler) cancellationHandler).remainingNanos > 0) {
            ...
            String str = z ? "Context" : "CallOptions";
            Long l = (Long) this.callOptions.getOption(ClientStreamTracer.NAME_RESOLUTION_DELAYED);
            double d = ((CancellationHandler) this.cancellationHandler).remainingNanos;
            double d2 = NANO_TO_SECS;
            this.stream = new FailingClientStream(Status.DEADLINE_EXCEEDED.withDescription(String.format("ClientCall started after %s deadline was exceeded %.9f seconds ago. Name resolution delay %.9f seconds.", str, Double.valueOf(d / d2), Double.valueOf(l == null ? 0.0d : l.longValue() / d2))), clientStreamTracers);
        }
    ...
    private final class CancellationHandler implements Runnable, Context.CancellationListener {
        ...
        Status formatDeadlineExceededStatus() {
            ...
            sb.append(this.contextIsDeadlineSource ? "Context" : "CallOptions");
            ...
            sb.append("s. ");
            sb.append(String.format(Locale.US, "Name resolution delay %.9f seconds.", Double.valueOf(((Long) ClientCallImpl.this.callOptions.getOption(ClientStreamTracer.NAME_RESOLUTION_DELAYED)) == null ? 0.0d : r0.longValue() / ClientCallImpl.NANO_TO_SECS)));
