...
abstract class RetriableStream<ReqT> implements ClientStream {
    ...
    public Runnable commit(final Substream substream) {
        ...
        synchronized (this.lock) {
            ...
            final boolean zIsCancelled = futureCanceller != null ? futureCanceller.isCancelled() : false;
            FutureCanceller futureCanceller2 = this.scheduledRetry;
            if (futureCanceller2 != null) {
                Future<?> futureMarkCancelled = futureCanceller2.markCancelled();
                this.scheduledRetry = null;
                future = futureMarkCancelled;
            } else {
                future = null;
            }
            FutureCanceller futureCanceller3 = this.scheduledHedging;
            if (futureCanceller3 != null) {
                Future<?> futureMarkCancelled2 = futureCanceller3.markCancelled();
            ...
            return new Runnable() { // from class: io.grpc.internal.RetriableStream.1CommitTask
                ...
                public void run() {
                    ...
                    if (future3 != null) {
                        ...
                        if (!zIsCancelled && RetriableStream.this.inFlightSubStreams.decrementAndGet() == Integer.MIN_VALUE) {
                            RetriableStream.this.listenerSerializeExecutor.execute(new Runnable() { // from class: io.grpc.internal.RetriableStream.1CommitTask.1
                                @Override // java.lang.Runnable
                                public void run() {
    ...
    */
    ...
    private final class Sublistener implements ClientStreamListener {
                        ...
                        if (RetriableStream.this.isHedging) {
                            ...
                            if (retryPlanMakeRetryDecision.shouldRetry) {
                                ...
                                futureCanceller.setFuture(RetriableStream.this.scheduledExecutorService.schedule(new Runnable() { // from class: io.grpc.internal.RetriableStream.Sublistener.1RetryBackoffRunnable
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        synchronized (futureCanceller.lock) {
                                            if (futureCanceller.isCancelled()) {
                                                return;
                                            }
                                            futureCanceller.markCancelled();
        ...
        private HedgingPlan makeHedgingDecision(Status status, Metadata metadata) {
            ...
            boolean z2 = (RetriableStream.this.throttle == null || (z && (pushbackMills == null || pushbackMills.intValue() >= 0))) ? false : !RetriableStream.this.throttle.onQualifiedFailureThenCheckIsAboveThreshold();
