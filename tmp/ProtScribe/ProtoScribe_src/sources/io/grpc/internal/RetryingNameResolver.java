...
final class RetryingNameResolver extends ForwardingNameResolver {
    ...
    class RetryingListener extends NameResolver.Listener2 {
        ...
        public Status onResult2(NameResolver.ResolutionResult resolutionResult) {
            Status statusOnResult2 = this.delegateListener.onResult2(resolutionResult);
            if (statusOnResult2.isOk()) {
