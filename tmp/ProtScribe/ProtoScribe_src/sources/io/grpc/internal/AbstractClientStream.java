...
public abstract class AbstractClientStream extends AbstractStream implements ClientStream, MessageFramer.Sink {
    ...
    public static abstract class TransportState extends AbstractStream.TransportState {
        ...
        protected TransportState(int i, StatsTraceContext statsTraceContext, TransportTracer transportTracer, CallOptions callOptions) {
        ...
        protected void inboundHeadersReceived(Metadata metadata) {
            ...
            this.statsTraceCtx.clientInboundHeaders(metadata);
