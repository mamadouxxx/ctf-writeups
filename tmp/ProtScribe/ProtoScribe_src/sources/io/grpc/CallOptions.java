...
public final class CallOptions {
    ...
    private static Builder toBuilder(CallOptions callOptions) {
        ...
        builder.onReadyThreshold = callOptions.onReadyThreshold;
        return builder;
    }
    ...
    public String toString() {
        ...
        return toStringHelperAdd.add("executor", executor != null ? executor.getClass() : null).add("compressorName", this.compressorName).add("customOptions", Arrays.deepToString(this.customOptions)).add("waitForReady", isWaitForReady()).add("maxInboundMessageSize", this.maxInboundMessageSize).add("maxOutboundMessageSize", this.maxOutboundMessageSize).add("onReadyThreshold", this.onReadyThreshold).add("streamTracerFactories", this.streamTracerFactories).toString();
    }
}
