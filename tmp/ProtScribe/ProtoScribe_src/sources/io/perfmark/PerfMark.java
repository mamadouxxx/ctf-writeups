...
public final class PerfMark {
    ...
    public static <T> void attachStringTag(String str, T t, Function<? super T, ? extends String> function) {
        impl.attachTag(str, t, function);
    }
    ...
    public static <T> void attachIntTag(String str, T t, ToIntFunction<? super T> toIntFunction) {
        impl.attachTag(str, t, toIntFunction);
    }

    public static <T> void attachLongTag(String str, T t, ToLongFunction<? super T> toLongFunction) {
        impl.attachTag(str, t, toLongFunction);
    }
