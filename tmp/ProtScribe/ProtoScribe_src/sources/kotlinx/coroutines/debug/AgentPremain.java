...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM217constructorimpl = Result.m217constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM217constructorimpl = Result.m217constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m223isFailureimpl(objM217constructorimpl) ? null : objM217constructorimpl);
