...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM217constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM217constructorimpl = Result.m217constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM217constructorimpl = Result.m217constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m220exceptionOrNullimpl(objM217constructorimpl) == null) {
            obj2 = objM217constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM217constructorimpl2 = Result.m217constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM217constructorimpl2 = Result.m217constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m220exceptionOrNullimpl(objM217constructorimpl2) == null) {
            obj = objM217constructorimpl2;
        }
