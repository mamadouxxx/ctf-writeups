...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM217constructorimpl = Result.m217constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM217constructorimpl = Result.m217constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1728boximpl(Result.m224isSuccessimpl(objM217constructorimpl) ? ChannelResult.INSTANCE.m1743successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1741closedJP2dKIU(Result.m220exceptionOrNullimpl(objM217constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1723trySendJP2dKIU = sendChannel.mo1723trySendJP2dKIU(e);
        if (objMo1723trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1738isSuccessimpl(sendChannel.mo1723trySendJP2dKIU(e))) {
            return;
        }
