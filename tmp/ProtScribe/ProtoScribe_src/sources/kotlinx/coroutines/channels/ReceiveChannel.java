...
public interface ReceiveChannel<E> {
    ...
    Object mo1721receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1722tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1722tryReceivePtdJZtk = receiveChannel.mo1722tryReceivePtdJZtk();
            if (ChannelResult.m1738isSuccessimpl(objMo1722tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1734getOrThrowimpl(objMo1722tryReceivePtdJZtk);
            }
            Throwable thM1732exceptionOrNullimpl = ChannelResult.m1732exceptionOrNullimpl(objMo1722tryReceivePtdJZtk);
            if (thM1732exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1732exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1721receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1733getOrNullimpl(r4)
                return r4
            */
