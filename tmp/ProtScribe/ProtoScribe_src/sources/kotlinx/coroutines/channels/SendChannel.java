...
public interface SendChannel<E> {
    ...
    Object mo1723trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1738isSuccessimpl(objMo1723trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1732exceptionOrNullimpl = ChannelResult.m1732exceptionOrNullimpl(objMo1723trySendJP2dKIU);
