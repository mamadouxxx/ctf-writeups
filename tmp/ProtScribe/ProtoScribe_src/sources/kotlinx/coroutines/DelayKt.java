...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1770scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1707delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1708toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1708toDelayMillisLRDsOJo(long j) {
        if (Duration.m1543compareToLRDsOJo(j, Duration.INSTANCE.m1646getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1562getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
