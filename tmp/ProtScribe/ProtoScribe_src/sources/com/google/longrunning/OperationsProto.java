...
public final class OperationsProto {
    ...
    static {
        ...
        extensionRegistryNewInstance.add((GeneratedMessage.GeneratedExtension<?, ?>) ClientProto.methodSignature);
