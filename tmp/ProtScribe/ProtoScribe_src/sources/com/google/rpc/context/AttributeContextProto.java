...
public final class AttributeContextProto {
    ...
    static final Descriptors.Descriptor internal_static_google_rpc_context_AttributeContext_Resource_AnnotationsEntry_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_google_rpc_context_AttributeContext_Resource_AnnotationsEntry_fieldAccessorTable;
    ...
    static {
        ...
        internal_static_google_rpc_context_AttributeContext_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{HttpHeaders.ORIGIN, "Source", "Destination", "Request", "Response", "Resource", "Api", "Extensions"});
        ...
        internal_static_google_rpc_context_AttributeContext_Request_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"Id", "Method", "Headers", "Path", HttpHeaders.HOST, "Scheme", "Query", "Time", "Size", "Protocol", "Reason", "Auth"});
        ...
        internal_static_google_rpc_context_AttributeContext_Response_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor9, new String[]{"Code", "Size", "Headers", "Time", "BackendLatency"});
        ...
        internal_static_google_rpc_context_AttributeContext_Resource_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor11, new String[]{"Service", "Name", "Type", "Labels", "Uid", "Annotations", "DisplayName", "CreateTime", "UpdateTime", "DeleteTime", "Etag", HttpHeaders.LOCATION});
        ...
        internal_static_google_rpc_context_AttributeContext_Resource_AnnotationsEntry_descriptor = descriptor13;
        internal_static_google_rpc_context_AttributeContext_Resource_AnnotationsEntry_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor13, new String[]{"Key", "Value"});
