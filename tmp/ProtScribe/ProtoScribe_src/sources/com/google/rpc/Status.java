...
public final class Status extends GeneratedMessageV3 implements StatusOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        return getCode() == status.getCode() && getMessage().equals(status.getMessage()) && getDetailsList().equals(status.getDetailsList()) && getUnknownFields().equals(status.getUnknownFields());
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements StatusOrBuilder {
        ...
        public Status build() {
            ...
            throw newUninitializedMessageException((Message) statusBuildPartial);
        }
        ...
        public Any.Builder getDetailsBuilder(int i) {
            return (Any.Builder) getDetailsFieldBuilder().getBuilder(i);
        }
        ...
        public Any.Builder addDetailsBuilder() {
            return (Any.Builder) getDetailsFieldBuilder().addBuilder(Any.getDefaultInstance());
        }

        public Any.Builder addDetailsBuilder(int i) {
            return (Any.Builder) getDetailsFieldBuilder().addBuilder(i, Any.getDefaultInstance());
        }
