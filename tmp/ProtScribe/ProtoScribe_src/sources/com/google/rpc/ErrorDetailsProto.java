...
public final class ErrorDetailsProto {
    ...
    static {
        ...
        internal_static_google_rpc_ErrorInfo_descriptor = descriptor2;
        internal_static_google_rpc_ErrorInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"Reason", "Domain", "Metadata"});
        Descriptors.Descriptor descriptor3 = descriptor2.getNestedTypes().get(0);
        internal_static_google_rpc_ErrorInfo_MetadataEntry_descriptor = descriptor3;
        internal_static_google_rpc_ErrorInfo_MetadataEntry_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Key", "Value"});
        Descriptors.Descriptor descriptor4 = getDescriptor().getMessageTypes().get(1);
        internal_static_google_rpc_RetryInfo_descriptor = descriptor4;
        internal_static_google_rpc_RetryInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"RetryDelay"});
        Descriptors.Descriptor descriptor5 = getDescriptor().getMessageTypes().get(2);
        internal_static_google_rpc_DebugInfo_descriptor = descriptor5;
        internal_static_google_rpc_DebugInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor5, new String[]{"StackEntries", "Detail"});
        Descriptors.Descriptor descriptor6 = getDescriptor().getMessageTypes().get(3);
        internal_static_google_rpc_QuotaFailure_descriptor = descriptor6;
        internal_static_google_rpc_QuotaFailure_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor6, new String[]{"Violations"});
        Descriptors.Descriptor descriptor7 = descriptor6.getNestedTypes().get(0);
        internal_static_google_rpc_QuotaFailure_Violation_descriptor = descriptor7;
        internal_static_google_rpc_QuotaFailure_Violation_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor7, new String[]{"Subject", "Description"});
