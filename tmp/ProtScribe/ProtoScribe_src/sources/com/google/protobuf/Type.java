...
public final class Type extends GeneratedMessage implements TypeOrBuilder {
    ...
    public void writeTo(CodedOutputStream output) throws IOException {
        ...
        for (int i2 = 0; i2 < this.oneofs_.size(); i2++) {
            GeneratedMessage.writeString(output, 3, this.oneofs_.getRaw(i2));
        }
    ...
    public static final class Builder extends GeneratedMessage.Builder<Builder> implements TypeOrBuilder {
        ...
        private void buildPartialRepeatedFields(Type result) {
            RepeatedFieldBuilder<Field, Field.Builder, FieldOrBuilder> repeatedFieldBuilder = this.fieldsBuilder_;
            if (repeatedFieldBuilder != null) {
                result.fields_ = repeatedFieldBuilder.build();
            } else {
        ...
        public Field getFields(int index) {
            ...
            return (Field) repeatedFieldBuilder.getMessage(index);
        }
        ...
        public FieldOrBuilder getFieldsOrBuilder(int index) {
            ...
            return (FieldOrBuilder) repeatedFieldBuilder.getMessageOrBuilder(index);
        }
