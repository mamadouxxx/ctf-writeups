...
public final class StringValue extends GeneratedMessage implements StringValueOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        int iComputeStringSize = (!GeneratedMessage.isStringEmpty(this.value_) ? GeneratedMessage.computeStringSize(1, this.value_) : 0) + getUnknownFields().getSerializedSize();
