...
public final class UnknownFieldSet implements MessageLite {
    ...
    public void writeTo(OutputStream output) throws IOException {
        CodedOutputStream codedOutputStreamNewInstance = CodedOutputStream.newInstance(output);
        writeTo(codedOutputStreamNewInstance);
    ...
    public static final class Builder implements MessageLite.Builder {
        ...
        private Field.Builder getFieldBuilder(int number) {
            ...
            this.fieldBuilders.put(Integer.valueOf(number), builderNewBuilder);
        ...
        public Builder m201clone() {
            ...
            for (Map.Entry<Integer, Field.Builder> entry : this.fieldBuilders.entrySet()) {
                builderNewBuilder.fieldBuilders.put(entry.getKey(), entry.getValue().m202clone());
            }
            return builderNewBuilder;
        }
        ...
        public boolean mergeFieldFrom(int tag, CodedInputStream input) throws IOException {
            ...
            if (tagWireType == 3) {
                Builder builderNewBuilder = UnknownFieldSet.newBuilder();
                input.readGroup(tagFieldNumber, builderNewBuilder, ExtensionRegistry.getEmptyRegistry());
        ...
        public Builder mergeFrom(byte[] data) throws InvalidProtocolBufferException {
            try {
                CodedInputStream codedInputStreamNewInstance = CodedInputStream.newInstance(data);
        ...
        public boolean mergeDelimitedFrom(InputStream input) throws IOException {
            ...
            mergeFrom((InputStream) new AbstractMessageLite.Builder.LimitedInputStream(input, CodedInputStream.readRawVarint32(i, input)));
            return true;
        }
    ...
    public static final class Field {
        ...
        public ByteString toByteString(int fieldNumber) {
            try {
                ByteString.CodedBuilder codedBuilderNewCodedBuilder = ByteString.newCodedBuilder(getSerializedSize(fieldNumber));
                writeTo(fieldNumber, codedBuilderNewCodedBuilder.getCodedOutput());
                return codedBuilderNewCodedBuilder.build();
            } catch (IOException e) {
        ...
        public void writeTo(int fieldNumber, CodedOutputStream output) throws IOException {
            for (int i = 0; i < this.varint.size(); i++) {
                output.writeUInt64(fieldNumber, this.varint.get(i).longValue());
            }
            for (int i2 = 0; i2 < this.fixed32.size(); i2++) {
                output.writeFixed32(fieldNumber, this.fixed32.get(i2).intValue());
            }
            for (int i3 = 0; i3 < this.fixed64.size(); i3++) {
                output.writeFixed64(fieldNumber, this.fixed64.get(i3).longValue());
            }
            for (int i4 = 0; i4 < this.lengthDelimited.size(); i4++) {
                output.writeBytes(fieldNumber, this.lengthDelimited.get(i4));
            }
            for (int i5 = 0; i5 < this.group.size(); i5++) {
                output.writeGroup(fieldNumber, this.group.get(i5));
            }
        }
        ...
        public int getSerializedSize(int fieldNumber) {
            ...
            for (int i = 0; i < this.varint.size(); i++) {
                iComputeGroupSize += CodedOutputStream.computeUInt64Size(fieldNumber, this.varint.get(i).longValue());
            }
            for (int i2 = 0; i2 < this.fixed32.size(); i2++) {
                iComputeGroupSize += CodedOutputStream.computeFixed32Size(fieldNumber, this.fixed32.get(i2).intValue());
            }
            for (int i3 = 0; i3 < this.fixed64.size(); i3++) {
                iComputeGroupSize += CodedOutputStream.computeFixed64Size(fieldNumber, this.fixed64.get(i3).longValue());
            }
            for (int i4 = 0; i4 < this.lengthDelimited.size(); i4++) {
                iComputeGroupSize += CodedOutputStream.computeBytesSize(fieldNumber, this.lengthDelimited.get(i4));
            }
            for (int i5 = 0; i5 < this.group.size(); i5++) {
                iComputeGroupSize += CodedOutputStream.computeGroupSize(fieldNumber, this.group.get(i5));
            }
        ...
        public void writeAsMessageSetExtensionTo(int fieldNumber, CodedOutputStream output) throws IOException {
            for (int i = 0; i < this.lengthDelimited.size(); i++) {
                output.writeRawMessageSetExtension(fieldNumber, this.lengthDelimited.get(i));
            }
        }
        ...
        public void writeAsMessageSetExtensionTo(int fieldNumber, Writer writer) throws IOException {
            if (writer.fieldOrder() == Writer.FieldOrder.DESCENDING) {
                for (int size = this.lengthDelimited.size() - 1; size >= 0; size--) {
                    writer.writeMessageSetItem(fieldNumber, this.lengthDelimited.get(size));
                }
                return;
            }
            for (int i = 0; i < this.lengthDelimited.size(); i++) {
                writer.writeMessageSetItem(fieldNumber, this.lengthDelimited.get(i));
            }
        }
        ...
        public int getSerializedSizeAsMessageSetExtension(int fieldNumber) {
            ...
            for (int i = 0; i < this.lengthDelimited.size(); i++) {
                iComputeRawMessageSetExtensionSize += CodedOutputStream.computeRawMessageSetExtensionSize(fieldNumber, this.lengthDelimited.get(i));
            }
    ...
    public static final class Parser extends AbstractParser<UnknownFieldSet> {
        ...
        public UnknownFieldSet parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            Builder builderNewBuilder = UnknownFieldSet.newBuilder();
            try {
                builderNewBuilder.mergeFrom(input);
