...
public final class DateTime extends GeneratedMessageV3 implements DateTimeOrBuilder {
    ...
    private static final Parser<DateTime> PARSER = new AbstractParser<DateTime>() { // from class: com.google.type.DateTime.1
        ...
        public DateTime parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            Builder builderNewBuilder = DateTime.newBuilder();
            try {
    ...
    public int getSerializedSize() {
        ...
        if (this.timeOffsetCase_ == 8) {
            iComputeInt32Size += CodedOutputStream.computeMessageSize(8, (Duration) this.timeOffset_);
        }
        if (this.timeOffsetCase_ == 9) {
            iComputeInt32Size += CodedOutputStream.computeMessageSize(9, (TimeZone) this.timeOffset_);
        }
    ...
    public int hashCode() {
        ...
        int iHashCode2 = ((((((((((((((((((((((((((((779 + getDescriptor().hashCode()) * 37) + 1) * 53) + getYear()) * 37) + 2) * 53) + getMonth()) * 37) + 3) * 53) + getDay()) * 37) + 4) * 53) + getHours()) * 37) + 5) * 53) + getMinutes()) * 37) + 6) * 53) + getSeconds()) * 37) + 7) * 53) + getNanos();
        int i2 = this.timeOffsetCase_;
        if (i2 == 8) {
            i = ((iHashCode2 * 37) + 8) * 53;
            iHashCode = getUtcOffset().hashCode();
        } else {
            if (i2 == 9) {
                i = ((iHashCode2 * 37) + 9) * 53;
                iHashCode = getTimeZone().hashCode();
            }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements DateTimeOrBuilder {
        ...
        public DateTime build() {
            ...
            throw newUninitializedMessageException((Message) dateTimeBuildPartial);
        }
        ...
        private void buildPartialOneofs(DateTime dateTime) {
            ...
            if (this.timeOffsetCase_ == 8 && (singleFieldBuilderV32 = this.utcOffsetBuilder_) != null) {
        ...
        public Duration.Builder getUtcOffsetBuilder() {
            return (Duration.Builder) getUtcOffsetFieldBuilder().getBuilder();
        }
        ...
        public TimeZone getTimeZone() {
            ...
            if (this.timeOffsetCase_ == 9) {
                return (TimeZone) singleFieldBuilderV3.getMessage();
            }
            return TimeZone.getDefaultInstance();
        }
        ...
        public TimeZone.Builder getTimeZoneBuilder() {
            return (TimeZone.Builder) getTimeZoneFieldBuilder().getBuilder();
        }
        ...
        public TimeZoneOrBuilder getTimeZoneOrBuilder() {
            ...
            if (i == 9 && (singleFieldBuilderV3 = this.timeZoneBuilder_) != null) {
                return (TimeZoneOrBuilder) singleFieldBuilderV3.getMessageOrBuilder();
            }
            if (i == 9) {
                return (TimeZone) this.timeOffset_;
            }
    ...
    /* JADX INFO: renamed from: com.google.type.DateTime$2, reason: invalid class name */
