...
public final class PostalAddress extends GeneratedMessageV3 implements PostalAddressOrBuilder {
    ...
    private LazyStringArrayList addressLines_;
    ...
    private LazyStringArrayList recipients_;
    ...
    private static final Parser<PostalAddress> PARSER = new AbstractParser<PostalAddress>() { // from class: com.google.type.PostalAddress.1
        ...
        public PostalAddress parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            Builder builderNewBuilder = PostalAddress.newBuilder();
            try {
    ...
    private PostalAddress(GeneratedMessageV3.Builder<?> builder) {
        ...
        this.locality_ = "";
        this.sublocality_ = "";
        this.addressLines_ = LazyStringArrayList.emptyList();
        this.recipients_ = LazyStringArrayList.emptyList();
        this.organization_ = "";
    ...
    public int getSerializedSize() {
        ...
        int size = iComputeInt32Size + iComputeStringSizeNoTag + getAddressLinesList().size();
        ...
        int size2 = size + iComputeStringSizeNoTag2 + getRecipientsList().size();
        if (!GeneratedMessageV3.isStringEmpty(this.organization_)) {
    ...
    public int hashCode() {
        ...
        if (getAddressLinesCount() > 0) {
            iHashCode = (((iHashCode * 37) + 9) * 53) + getAddressLinesList().hashCode();
        }
        if (getRecipientsCount() > 0) {
            iHashCode = (((iHashCode * 37) + 10) * 53) + getRecipientsList().hashCode();
        }
        int iHashCode2 = (((((iHashCode * 37) + 11) * 53) + getOrganization().hashCode()) * 29) + getUnknownFields().hashCode();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements PostalAddressOrBuilder {
        ...
        public PostalAddress build() {
            ...
            throw newUninitializedMessageException((Message) postalAddressBuildPartial);
        }
        ...
        public PostalAddress buildPartial() {
            ...
            if (this.bitField0_ != 0) {
                buildPartial0(postalAddress);
            }
            onBuilt();
            return postalAddress;
        }

        private void buildPartial0(PostalAddress postalAddress) {
                    ...
                    try {
                        ...
                        switch (tag) {
                            ...
                            case 74:
                                ...
                                ensureAddressLinesIsMutable();
                                this.addressLines_.add((Object) stringRequireUtf8);
                                break;
                            case 82:
                                String stringRequireUtf82 = codedInputStream.readStringRequireUtf8();
                                ensureRecipientsIsMutable();
                                this.recipients_.add((Object) stringRequireUtf82);
                                break;
                            case 90:
        ...
        private void ensureAddressLinesIsMutable() {
            if (!this.addressLines_.isModifiable()) {
                this.addressLines_ = new LazyStringArrayList((LazyStringList) this.addressLines_);
            }
            this.bitField0_ |= 256;
        }
        ...
        public Builder addAddressLines(String str) {
            str.getClass();
            ensureAddressLinesIsMutable();
            this.addressLines_.add((Object) str);
            this.bitField0_ |= 256;
            onChanged();
            return this;
        }
        ...
        private void ensureRecipientsIsMutable() {
            if (!this.recipients_.isModifiable()) {
                this.recipients_ = new LazyStringArrayList((LazyStringList) this.recipients_);
            }
            this.bitField0_ |= 512;
        }
        ...
        public Builder addRecipients(String str) {
            str.getClass();
            ensureRecipientsIsMutable();
            this.recipients_.add((Object) str);
            this.bitField0_ |= 512;
            onChanged();
            return this;
        }
