...
public final class HttpRequest extends GeneratedMessageV3 implements HttpRequestOrBuilder {
    ...
    private static final Parser<HttpRequest> PARSER = new AbstractParser<HttpRequest>() { // from class: com.google.logging.type.HttpRequest.1
        ...
        public HttpRequest parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            Builder builderNewBuilder = HttpRequest.newBuilder();
            try {
    ...
    static /* synthetic */ int access$1976(HttpRequest httpRequest, int i) {
        int i2 = i | httpRequest.bitField0_;
    ...
    public int getSerializedSize() {
        ...
        int iComputeStringSize = !GeneratedMessageV3.isStringEmpty(this.requestMethod_) ? GeneratedMessageV3.computeStringSize(1, this.requestMethod_) : 0;
        if (!GeneratedMessageV3.isStringEmpty(this.requestUrl_)) {
    ...
    public int hashCode() {
        ...
        int iHashBoolean = (((((((((((((((((((((iHashCode * 37) + 11) * 53) + Internal.hashBoolean(getCacheLookup())) * 37) + 9) * 53) + Internal.hashBoolean(getCacheHit())) * 37) + 10) * 53) + Internal.hashBoolean(getCacheValidatedWithOriginServer())) * 37) + 12) * 53) + Internal.hashLong(getCacheFillBytes())) * 37) + 15) * 53) + getProtocol().hashCode()) * 29) + getUnknownFields().hashCode();
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements HttpRequestOrBuilder {
        ...
        public HttpRequest build() {
            ...
            throw newUninitializedMessageException((Message) httpRequestBuildPartial);
        }
        ...
        private void buildPartial0(HttpRequest httpRequest) {
            ...
            if ((i2 & 512) != 0) {
                SingleFieldBuilderV3<Duration, Duration.Builder, DurationOrBuilder> singleFieldBuilderV3 = this.latencyBuilder_;
                httpRequest.latency_ = singleFieldBuilderV3 == null ? this.latency_ : (Duration) singleFieldBuilderV3.build();
                i = 1;
            } else {
                i = 0;
            }
            ...
            HttpRequest.access$1976(httpRequest, i);
        }
        ...
        public Builder mergeLatency(Duration duration) {
            ...
            SingleFieldBuilderV3<Duration, Duration.Builder, DurationOrBuilder> singleFieldBuilderV3 = this.latencyBuilder_;
            if (singleFieldBuilderV3 == null) {
                if ((this.bitField0_ & 512) != 0 && (duration2 = this.latency_) != null && duration2 != Duration.getDefaultInstance()) {
