...
public final class SystemParameters extends GeneratedMessageV3 implements SystemParametersOrBuilder {
    ...
    private static final Parser<SystemParameters> PARSER = new AbstractParser<SystemParameters>() { // from class: com.google.api.SystemParameters.1
        ...
        public SystemParameters parsePartialFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
            Builder builderNewBuilder = SystemParameters.newBuilder();
            try {
    ...
    public boolean equals(Object obj) {
        ...
        return getRulesList().equals(systemParameters.getRulesList()) && getUnknownFields().equals(systemParameters.getUnknownFields());
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements SystemParametersOrBuilder {
        ...
        private void buildPartial0(SystemParameters systemParameters) {
        }
        ...
        public SystemParameters build() {
            SystemParameters systemParametersBuildPartial = buildPartial();
            if (systemParametersBuildPartial.isInitialized()) {
                return systemParametersBuildPartial;
            }
            throw newUninitializedMessageException((Message) systemParametersBuildPartial);
        }

        @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
        public SystemParameters buildPartial() {
            SystemParameters systemParameters = new SystemParameters(this);
            buildPartialRepeatedFields(systemParameters);
            if (this.bitField0_ != 0) {
                buildPartial0(systemParameters);
            }
            onBuilt();
            return systemParameters;
        }

        private void buildPartialRepeatedFields(SystemParameters systemParameters) {
            RepeatedFieldBuilderV3<SystemParameterRule, SystemParameterRule.Builder, SystemParameterRuleOrBuilder> repeatedFieldBuilderV3 = this.rulesBuilder_;
            if (repeatedFieldBuilderV3 != null) {
        ...
        public Builder mergeFrom(SystemParameters systemParameters) {
            ...
            mergeUnknownFields(systemParameters.getUnknownFields());
            onChanged();
            return this;
        }
            ...
            while (!z) {
                try {
                    try {
                        ...
                        if (tag != 0) {
                            if (tag == 10) {
                                SystemParameterRule systemParameterRule = (SystemParameterRule) codedInputStream.readMessage(SystemParameterRule.parser(), extensionRegistryLite);
                                RepeatedFieldBuilderV3<SystemParameterRule, SystemParameterRule.Builder, SystemParameterRuleOrBuilder> repeatedFieldBuilderV3 = this.rulesBuilder_;
                                if (repeatedFieldBuilderV3 == null) {
                                    ensureRulesIsMutable();
        ...
        public SystemParameterRule.Builder getRulesBuilder(int i) {
            return (SystemParameterRule.Builder) getRulesFieldBuilder().getBuilder(i);
        }
        ...
        public SystemParameterRule.Builder addRulesBuilder() {
            return (SystemParameterRule.Builder) getRulesFieldBuilder().addBuilder(SystemParameterRule.getDefaultInstance());
        }

        public SystemParameterRule.Builder addRulesBuilder(int i) {
            return (SystemParameterRule.Builder) getRulesFieldBuilder().addBuilder(i, SystemParameterRule.getDefaultInstance());
        }
