...
public final class DistributionProto {
    ...
    static {
        ...
        internal_static_google_api_Distribution_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor2, new String[]{"Count", "Mean", "SumOfSquaredDeviation", HttpHeaders.RANGE, "BucketOptions", "BucketCounts", "Exemplars"});
