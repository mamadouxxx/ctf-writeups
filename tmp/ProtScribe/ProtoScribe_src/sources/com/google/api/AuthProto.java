...
public final class AuthProto {
    ...
    static {
        ...
        internal_static_google_api_JwtLocation_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"Header", "Query", HttpHeaders.COOKIE, "ValuePrefix", "In"});
