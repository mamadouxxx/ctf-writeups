...
public final class BackendProto {
    ...
    static final Descriptors.Descriptor internal_static_google_api_BackendRule_OverridesByRequestProtocolEntry_descriptor;
    static final GeneratedMessageV3.FieldAccessorTable internal_static_google_api_BackendRule_OverridesByRequestProtocolEntry_fieldAccessorTable;
    ...
    static {
        ...
        internal_static_google_api_BackendRule_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor3, new String[]{"Selector", "Address", "Deadline", "MinDeadline", "OperationDeadline", "PathTranslation", "JwtAudience", "DisableAuth", "Protocol", "OverridesByRequestProtocol", "Authentication"});
        Descriptors.Descriptor descriptor4 = descriptor3.getNestedTypes().get(0);
        internal_static_google_api_BackendRule_OverridesByRequestProtocolEntry_descriptor = descriptor4;
        internal_static_google_api_BackendRule_OverridesByRequestProtocolEntry_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(descriptor4, new String[]{"Key", "Value"});
    }
}
