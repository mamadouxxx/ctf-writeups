...
public final class UnsignedKt {
    ...
    public static final int m569uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m313constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m570uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m313constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m571ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? ULong.m392constructorimpl(0L) : ULong.m392constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m392constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m392constructorimpl(j3 + ((long) (Long.compare(ULong.m392constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m392constructorimpl(j2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m572ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? j : ULong.m392constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m392constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compare(ULong.m392constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m392constructorimpl(j2) ^ Long.MIN_VALUE) < 0) {
            j2 = 0;
        }
        return ULong.m392constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m313constructorimpl((int) d);
        }
        return UInt.m313constructorimpl(UInt.m313constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m313constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m392constructorimpl((long) d);
        }
        return ULong.m392constructorimpl(ULong.m392constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
