...
public final class UStringsKt {
    ...
    public static final String m1530toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1532toStringolVBNx4(short s, int i) {
    ...
    public static final String m1531toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1529toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m313constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m229boximpl(UByte.m235constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m313constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m493boximpl(UShort.m499constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM313constructorimpl = UInt.m313constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM313constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM313constructorimpl2 = UInt.m313constructorimpl(i3 * iM313constructorimpl);
            int iM313constructorimpl3 = UInt.m313constructorimpl(UInt.m313constructorimpl(iDigitOf) + iM313constructorimpl2);
            if (Integer.compare(iM313constructorimpl3 ^ Integer.MIN_VALUE, iM313constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM313constructorimpl3;
        }
        return UInt.m307boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM392constructorimpl = ULong.m392constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM392constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM392constructorimpl2 = ULong.m392constructorimpl(j * jM392constructorimpl);
            long jM392constructorimpl3 = ULong.m392constructorimpl(ULong.m392constructorimpl(((long) UInt.m313constructorimpl(iDigitOf)) & 4294967295L) + jM392constructorimpl2);
            if (Long.compare(jM392constructorimpl3 ^ Long.MIN_VALUE, jM392constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM392constructorimpl3;
        }
        return ULong.m386boximpl(j);
    }
}
