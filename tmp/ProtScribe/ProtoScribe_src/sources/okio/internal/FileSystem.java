...
public final class FileSystem {
    ...
    static final class C01591 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C01591(Path path, okio.FileSystem fileSystem, boolean z, Continuation<? super C01591> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01591 c01591 = new C01591(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c01591.L$0 = obj;
            return c01591;
        }
    ...
    public static final Sequence<Path> commonListRecursively(okio.FileSystem fileSystem, Path dir, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(fileSystem, "<this>");
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C01591(dir, fileSystem, z, null));
    }
