...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM142constructorimpl = Result.m142constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM142constructorimpl = Result.m142constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m148isFailureimpl(objM142constructorimpl) ? null : objM142constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1671installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1671installSignalHandler$lambda1(Signal signal) {
