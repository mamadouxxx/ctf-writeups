...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo1648trySendJP2dKIU(E element) {
        Object objOfferInternal = offerInternal(element);
        if (objOfferInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m1668successJP2dKIU(Unit.INSTANCE);
        }
        if (objOfferInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m1667failurePtdJZtk() : ChannelResult.INSTANCE.m1666closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (objOfferInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1666closedJP2dKIU(helpCloseAndGetSendException((Closed) objOfferInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m142constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m142constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1693remove()) {
                receive.helpRemove();
            } else {
                objM1685constructorimpl$default = InlineList.m1690plusFjFbRPM(objM1685constructorimpl$default, receive);
            }
        }
        if (objM1685constructorimpl$default != null) {
            if (!(objM1685constructorimpl$default instanceof ArrayList)) {
                ((Receive) objM1685constructorimpl$default).resumeReceiveClosed(closed);
            } else if (objM1685constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) objM1685constructorimpl$default;
    ...
    */
    public final java.lang.Object sendSuspend(E r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L61:
            ...
            java.lang.Object r5 = kotlin.Result.m142constructorimpl(r5)
            r1.resumeWith(r5)
            goto L86
        L77:
