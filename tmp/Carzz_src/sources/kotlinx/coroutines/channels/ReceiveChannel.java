...
public interface ReceiveChannel<E> {
    ...
    Object mo1646receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1647tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1647tryReceivePtdJZtk = receiveChannel.mo1647tryReceivePtdJZtk();
            if (ChannelResult.m1663isSuccessimpl(objMo1647tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1659getOrThrowimpl(objMo1647tryReceivePtdJZtk);
            }
            Throwable thM1657exceptionOrNullimpl = ChannelResult.m1657exceptionOrNullimpl(objMo1647tryReceivePtdJZtk);
            if (thM1657exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1657exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1646receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1658getOrNullimpl(r4)
                return r4
            */
