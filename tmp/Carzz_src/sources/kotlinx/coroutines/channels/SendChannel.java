...
public interface SendChannel<E> {
    ...
    Object mo1648trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1663isSuccessimpl(objMo1648trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1657exceptionOrNullimpl = ChannelResult.m1657exceptionOrNullimpl(objMo1648trySendJP2dKIU);
