...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM142constructorimpl = Result.m142constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM142constructorimpl = Result.m142constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1653boximpl(Result.m149isSuccessimpl(objM142constructorimpl) ? ChannelResult.INSTANCE.m1668successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1666closedJP2dKIU(Result.m145exceptionOrNullimpl(objM142constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1648trySendJP2dKIU = sendChannel.mo1648trySendJP2dKIU(e);
        if (objMo1648trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1663isSuccessimpl(sendChannel.mo1648trySendJP2dKIU(e))) {
            return;
        }
