...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM142constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM142constructorimpl = Result.m142constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM142constructorimpl = Result.m142constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m145exceptionOrNullimpl(objM142constructorimpl) == null) {
            obj2 = objM142constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM142constructorimpl2 = Result.m142constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM142constructorimpl2 = Result.m142constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m145exceptionOrNullimpl(objM142constructorimpl2) == null) {
            obj = objM142constructorimpl2;
        }
