...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1695scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1632delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1633toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1633toDelayMillisLRDsOJo(long j) {
        if (Duration.m1468compareToLRDsOJo(j, Duration.INSTANCE.m1571getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1487getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
