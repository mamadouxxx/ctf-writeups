...
public interface TimeMark {
    ...
    TimeMark mo1459minusLRDsOJo(long duration);

    /* JADX INFO: renamed from: plus-LRDsOJo */
    TimeMark mo1461plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1605minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1461plusLRDsOJo(Duration.m1521unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1502isNegativeimpl(timeMark.mo1458elapsedNowUwyO8pc());
        }
