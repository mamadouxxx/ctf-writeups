...
public final class DurationKt {
    ...
    private static final long m1595timesmvk6XK0(int i, long j) {
        return Duration.m1507timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1594timeskIfJnKk(double d, long j) {
        return Duration.m1506timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1571getZEROUwyO8pc = Duration.INSTANCE.m1571getZEROUwyO8pc();
        ...
        if (str2.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str2.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        z4 = z7;
                        long jM1505plusLRDsOJo = Duration.m1505plusLRDsOJo(jM1571getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1571getZEROUwyO8pc = Duration.m1505plusLRDsOJo(jM1505plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        z4 = z7;
                        jM1571getZEROUwyO8pc = Duration.m1505plusLRDsOJo(jM1571getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    z7 = z4;
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, "Infinity".length()), true)) {
                jM1571getZEROUwyO8pc = Duration.INSTANCE.m1569getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1505plusLRDsOJo2 = Duration.m1505plusLRDsOJo(jM1571getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1571getZEROUwyO8pc = Duration.m1505plusLRDsOJo(jM1505plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM1571getZEROUwyO8pc = Duration.m1505plusLRDsOJo(jM1571getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m1521unaryMinusUwyO8pc(jM1571getZEROUwyO8pc) : jM1571getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1469constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1469constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1469constructorimpl((j << 1) + ((long) i));
    }
