...
public final class LongSaturatedMathKt {
    ...
    public static final long m1597saturatingAddpTJri5U(long j, long j2) {
        long jM1489getInWholeNanosecondsimpl = Duration.m1489getInWholeNanosecondsimpl(j2);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m1596checkInfiniteSumDefinedPjuGub4(j, j2, jM1489getInWholeNanosecondsimpl);
        }
        if ((1 | (jM1489getInWholeNanosecondsimpl - 1)) == Long.MAX_VALUE) {
            return m1598saturatingAddInHalvespTJri5U(j, j2);
        }
        long j3 = j + jM1489getInWholeNanosecondsimpl;
        return ((j ^ j3) & (jM1489getInWholeNanosecondsimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* JADX INFO: renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m1596checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m1501isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m1598saturatingAddInHalvespTJri5U(long j, long j2) {
        long jM1472divUwyO8pc = Duration.m1472divUwyO8pc(j2, 2);
        if (((Duration.m1489getInWholeNanosecondsimpl(jM1472divUwyO8pc) - 1) | 1) == Long.MAX_VALUE) {
            return (long) (j + Duration.m1512toDoubleimpl(j2, DurationUnit.NANOSECONDS));
        }
        return m1597saturatingAddpTJri5U(m1597saturatingAddpTJri5U(j, jM1472divUwyO8pc), Duration.m1504minusLRDsOJo(j2, jM1472divUwyO8pc));
    }

    public static final long saturatingDiff(long j, long j2) {
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m1521unaryMinusUwyO8pc(DurationKt.toDuration(j2, DurationUnit.DAYS));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            ...
            return Duration.m1505plusLRDsOJo(duration, DurationKt.toDuration(j6, DurationUnit.NANOSECONDS));
        }
