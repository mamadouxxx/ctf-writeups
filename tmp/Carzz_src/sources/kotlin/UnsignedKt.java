...
public final class UnsignedKt {
    ...
    public static final int m494uintDivideJ1ME1BU(int i, int i2) {
    ...
    public static final int m495uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m238constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m496ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? ULong.m317constructorimpl(0L) : ULong.m317constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m317constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m317constructorimpl(j3 + ((long) (Long.compare(ULong.m317constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m317constructorimpl(j2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m497ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? j : ULong.m317constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m317constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compare(ULong.m317constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m317constructorimpl(j2) ^ Long.MIN_VALUE) < 0) {
            j2 = 0;
        }
        return ULong.m317constructorimpl(j3 - j2);
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m317constructorimpl((long) d);
        }
        return ULong.m317constructorimpl(ULong.m317constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
