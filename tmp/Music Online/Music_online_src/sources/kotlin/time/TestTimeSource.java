...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1636plusAssignLRDsOJo(long duration) {
        long jM1546toLongimpl = Duration.m1546toLongimpl(duration, getUnit());
        if (((jM1546toLongimpl - 1) | 1) != Long.MAX_VALUE) {
            long j = this.reading;
            long j2 = j + jM1546toLongimpl;
            if ((jM1546toLongimpl ^ j) >= 0 && (j ^ j2) < 0) {
                m1635overflowLRDsOJo(duration);
            }
            this.reading = j2;
            return;
        }
        long jM1503divUwyO8pc = Duration.m1503divUwyO8pc(duration, 2);
        if ((1 | (Duration.m1546toLongimpl(jM1503divUwyO8pc, getUnit()) - 1)) != Long.MAX_VALUE) {
            long j3 = this.reading;
            try {
                m1636plusAssignLRDsOJo(jM1503divUwyO8pc);
                m1636plusAssignLRDsOJo(Duration.m1535minusLRDsOJo(duration, jM1503divUwyO8pc));
                return;
    ...
    private final void m1635overflowLRDsOJo(long duration) {
