...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1382getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM349constructorimpl = ((int) ULong.m349constructorimpl(j ^ ULong.m349constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM349constructorimpl2 = (iM349constructorimpl + ((int) ULong.m349constructorimpl(j2 ^ ULong.m349constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM349constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m395toStringimpl(this.first)).append("..").append((Object) ULong.m395toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m395toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m395toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
