...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1727scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1664delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1665toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1665toDelayMillisLRDsOJo(long j) {
        if (Duration.m1499compareToLRDsOJo(j, Duration.INSTANCE.m1603getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1518getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
