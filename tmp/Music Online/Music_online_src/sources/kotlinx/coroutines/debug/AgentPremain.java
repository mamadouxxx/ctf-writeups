...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM174constructorimpl = Result.m174constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM174constructorimpl = Result.m174constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m180isFailureimpl(objM174constructorimpl) ? null : objM174constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1703installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1703installSignalHandler$lambda1(Signal signal) {
