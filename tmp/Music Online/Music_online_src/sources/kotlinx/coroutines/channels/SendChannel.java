...
public interface SendChannel<E> {
    ...
    Object mo1680trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1695isSuccessimpl(objMo1680trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1689exceptionOrNullimpl = ChannelResult.m1689exceptionOrNullimpl(objMo1680trySendJP2dKIU);
