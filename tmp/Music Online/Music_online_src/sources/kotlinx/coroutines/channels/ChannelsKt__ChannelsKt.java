...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM174constructorimpl = Result.m174constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM174constructorimpl = Result.m174constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1685boximpl(Result.m181isSuccessimpl(objM174constructorimpl) ? ChannelResult.INSTANCE.m1700successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1698closedJP2dKIU(Result.m177exceptionOrNullimpl(objM174constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1680trySendJP2dKIU = sendChannel.mo1680trySendJP2dKIU(e);
        if (objMo1680trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1695isSuccessimpl(sendChannel.mo1680trySendJP2dKIU(e))) {
            return;
        }
