...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1727scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1727scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
    ...
    public void mo1726dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo1726dispatch(this, this);
    }
