...
public final class HttpUrl {
    ...
    public final String m1795deprecated_encodedUsername() {
    ...
    public final String m1791deprecated_encodedPassword() {
    ...
    public static final class Companion {
        ...
        public final HttpUrl m1809deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m1812deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1811deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m1810deprecated_get(URI uri) {
