...
public final class FileSystem {
    ...
    static final class C01371 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Path>, Continuation<? super Unit>, Object> {
        ...
        C01371(Path path, okio.FileSystem fileSystem, boolean z, Continuation<? super C01371> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01371 c01371 = new C01371(this.$dir, this.$this_commonListRecursively, this.$followSymlinks, continuation);
            c01371.L$0 = obj;
            return c01371;
        }
        ...
        public final Object invoke(SequenceScope<? super Path> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C01371) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final Sequence<Path> commonListRecursively(okio.FileSystem fileSystem, Path dir, boolean z) throws IOException {
        Intrinsics.checkNotNullParameter(fileSystem, "<this>");
        Intrinsics.checkNotNullParameter(dir, "dir");
        return SequencesKt.sequence(new C01371(dir, fileSystem, z, null));
    }
