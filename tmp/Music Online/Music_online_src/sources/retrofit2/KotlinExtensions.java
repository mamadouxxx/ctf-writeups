    ...
    public static final <T> Object await(final Call<T> call, Continuation<? super T> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (tBody == null) {
                        ...
                        cancellableContinuation.resumeWith(Result.m174constructorimpl(ResultKt.createFailure(kotlinNullPointerException)));
                        return;
                    }
                    CancellableContinuation<T> cancellableContinuation2 = cancellableContinuationImpl2;
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m174constructorimpl(tBody));
                    return;
                }
                CancellableContinuation<T> cancellableContinuation3 = cancellableContinuationImpl2;
                Result.Companion companion3 = Result.INSTANCE;
                cancellableContinuation3.resumeWith(Result.m174constructorimpl(ResultKt.createFailure(new HttpException(response))));
            }
            ...
            public void onFailure(Call<T> call2, Throwable t) {
                ...
                CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m174constructorimpl(ResultKt.createFailure(t)));
            }
        });
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$await$4$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                if (response.isSuccessful()) {
                    CancellableContinuation<T> cancellableContinuation = cancellableContinuationImpl2;
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuation.resumeWith(Result.m174constructorimpl(response.body()));
                } else {
                    CancellableContinuation<T> cancellableContinuation2 = cancellableContinuationImpl2;
                    Result.Companion companion2 = Result.INSTANCE;
                    cancellableContinuation2.resumeWith(Result.m174constructorimpl(ResultKt.createFailure(new HttpException(response))));
                }
            }
    ...
    public static final <T> Object awaitResponse(final Call<T> call, Continuation<? super Response<T>> continuation) {
        ...
        call.enqueue(new Callback<T>() { // from class: retrofit2.KotlinExtensions$awaitResponse$2$2
            ...
            public void onResponse(Call<T> call2, Response<T> response) {
                ...
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuation.resumeWith(Result.m174constructorimpl(response));
            }
